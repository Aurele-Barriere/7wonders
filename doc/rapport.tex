...
En effet, le problème de \texttt{hegemony} est à la fin du jeu : toutes les zones entourées par notre couleur mais qui ne sont pas de notre couleur ne seront pas coloriées. En effet, les colorier réduirait notre zone, alors qu'on a intérêt à la prendre.
